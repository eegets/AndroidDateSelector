package com.example.androiddateselector.wheel.wheel;
...
import com.example.androiddateselector.wheel.config.SceenMannage;
...
public class WheelView extends ScrollView {
    ...
    /** 当前条目中的文字大小 */
    private int VALUE_TEXT_SIZE = 20;
    
    /** 非当前条目的文字颜色 */
    private static final int ITEMS_TEXT_COLOR = 0xFF828282;
...
//    private static final int[] SHADOWS_COLORS = new int[] { 0xFF5436EE, 0x0012CEAE, 0x0012CEAE };
    ...
    public void setTextSize(int VALUE_TEXT_SIZE){
    	this.VALUE_TEXT_SIZE = VALUE_TEXT_SIZE;
    }
    ...
    private void initResourcesIfNecessary() {
        ...
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(new SceenMannage(getContext()).sp2px(TEXT_SIZE));
        }
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(new SceenMannage(getContext()).sp2px(TEXT_SIZE));
            valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
        }

        //选中的条目背景
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.transparent);
        }
...
//    	valuePaint.setTextAlign(Paint.Align.CENTER);
        ...
        valuePaint.setTextSize(new SceenMannage(getContext()).sp2px(VALUE_TEXT_SIZE));
...
//        FontMetrics fm = valuePaint.getFontMetrics();
        ...
        if (valueLayout != null) {
            canvas.save();
            canvas.translate(0, bounds.top +1+ scrollingOffset);
