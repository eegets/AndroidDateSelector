package com.example.androiddateselector.wheel.config;
...
public class SceenMannage {
	private int STANDARD_WITH = 480;// 标准宽的像素
	private int STANDARD_HEIGTH = 854;// 标准高的像素
...
//		System.out.println("适配�? + CURRENT_DENSITY + "Width" + small + "height" + large);
